...
class LSTM_CRF(nn.Module):
    ...
    def init_hidden(self):
        return (torch.randn(self.lstm_layers, self.bs, self.hidden_dim),
                torch.randn(self.lstm_layers, self.bs, self.hidden_dim))
...
if __name__ == "__main__":
    ...
    model = LSTM_CRF(len(word_to_ix), tag_to_ix,
